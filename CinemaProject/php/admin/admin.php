...
<html lang="en">
    ...
    <br>
    <a href="../cliente/cliente.php" class="btn btn-success">Listar CLientes</a>
    <a href="../cliente/createCliente.php" class="btn btn-info">Cadastrar CLientes</a>
    <br><br>
    <a  href="../filme/filme.php" class="btn btn-secondary">Listar Filmes</a>
    <a  href="../filme/createFilme.php" class="btn btn-warning">Adcionar Filmes</a>
